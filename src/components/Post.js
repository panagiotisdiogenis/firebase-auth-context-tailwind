...
const Post = ({ post }) => {
  ...
  return (
    <>
      <div onClick={(e) => handleClickPost(e)} className={`w-full max-w-xl p-6 mb-4 bg-white border border-[#dbdbdb] rounded-lg hover:cursor-pointer dark:bg-black dark:border-[#333] dark:text-white dark:hover:bg-black/50`}>
        <div className='flex'>
          ...
          <div className=''>
            <div>
              ...
              <p className='text-[15px] text-zinc-600 inline font-medium dark:text-zinc-500'>{timeSince(post.timestamp)}</p>
            </div>
            {post.text ? <p className="pt-2 text-[15px] text-slate-900 dark:text-white">{post.text} </p> : null}
            {post.image ? <img src={post.image} className='mt-4 rounded-lg w-full' alt='upload' /> : null}
            <div className='mt-4'>
              <span className='group'>
                <svg onClick={(e) => handleClickLike(e)} xmlns="http://www.w3.org/2000/svg" fill={liked ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${liked ? 'text-[#FA1A7F]' : 'text-zinc-600 dark:text-zinc-500'} w-5 h-5 align-text-bottom inline hover:text-[#FA1A7F] hover:cursor-pointer group-hover:text-[#FA1A7F]`}>
              ...
              <span className='group'>
                <svg onClick={(e) => handleClickComment(e)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-zinc-600 inline ml-4 align-text-bottom hover:cursor-pointer group-hover:text-[#1d9cef] dark:text-zinc-500">
              ...
              <svg onClick={(e) => handleClickDelete(e)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-zinc-600 inline align-text-bottom ml-8 hover:cursor-pointer hover:text-[#FA1A7F] dark:text-zinc-500 dark:hover:text-[#FA1A7F]">
