    ...
    <form className='w-full max-w-xl mb-4'>
      <div className="border border-[#dbdbdb] rounded-lg bg-gray-50 dark:bg-black dark:border-[#333]">
        ...
        <div className="flex items-center justify-between bg-white rounded-lg px-6 py-6 border-[#dbdbdb] dark:bg-black dark:border-[#333]">
          ...
          <button disabled={imageUpload && url === '' ? true : false} onClick={handleCreatePost} type="button" className="disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-[#0F1419] hover:bg-[#333] rounded-full focus:ring-4 focus:ring-gray-300 dark:bg-black dark:border-[1px] dark:border-[#333] dark:hover:bg-[#111] dark:focus:ring-0">
            {imageUpload && url === '' ?
              <svg aria-hidden="true" className="inline w-4 h-4 text-gray-200 animate-spin fill-[#FA1A7F] dark:text-[#333]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
