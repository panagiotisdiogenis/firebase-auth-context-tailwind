    ...
    <div className="container mx-auto bg-gray-50 h-screen">
      <div className='flex flex-col items-center p-4'>
        <div className='max-w-xl w-full'>
          <button onClick={() => navigate(-1)} className="text-gray-900 bg-white text-sm border border-gray-300 focus:outline-none hover:bg-gray-100 rounded-full px-4 py-2 mb-4">
            ...
            <span className='ml-2 inline font-bold text-slate-900'>Back</span>
          </button>
        </div>
