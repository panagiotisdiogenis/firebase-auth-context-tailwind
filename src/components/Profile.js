...
const Profile = () => {
  ...
  return (
    <>
      <Nav />
      {user ?
        <div className='sm:hidden z-10 fixed top-0 right-0 h-full w-full'>
          <div onClick={handleCreatePost} className='z-20 flex w-16 h-16 items-center justify-center absolute m-6 bottom-0 right-0 text-3xl bg-white border border-[#dbdbdb] dark:border-[#333] dark:bg-[#111] rounded-full'>
